  ...
  return (
    <div className='bg-gray-100 flex justify-between mt-8 p-4'>
      <div className='flex items-center'>
        ...
        <button className='text-white px-4 py-2 h-10 bg-orange border outline-none rounded-sm mr-2 shadow-sm'>
          Phổ biến
        </button>
        <button className=' bg-white px-4 py-2 h-10 outline-none rounded-sm mr-2 shadow-sm'>Mới nhất</button>
        <button className='bg-white px-4 py-2 h-10 outline-none rounded-sm mr-2 shadow-sm'>Bán chạy</button>
        <select className='text-sm outline-none capitalize px-2 py-2 h-10 border rounded-sm shadow-sm'>
          <option>Giá</option>
      ...
      <div className='flex items-center'>
        ...
        <button className='bg-gray-200  p-2 border border-sm border-gray-100 outline-none text-gray-200'>
        ...
        <button className='bg-gray-200 p-2 border border-sm border-gray-100 outline-none '>
